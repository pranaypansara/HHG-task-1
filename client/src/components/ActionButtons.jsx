...
export default function ActionButtons({ onDownload, onShare, isDownloading = false }) {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-[340px] mt-6">
      {/* Download Button */}
      <motion.button
      ...
      >
        {isDownloading ? (
          <div className="flex items-center space-x-2">
            <svg className="animate-spin h-4 w-4 text-brand-green-darkest" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
